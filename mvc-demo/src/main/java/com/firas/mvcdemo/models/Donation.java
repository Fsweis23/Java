package com.firas.mvcdemo.models;
...
public class Donation {
    ...
    @NotNull(message = "donationName is required!") // validation for not null
    private String donationName; // the presistant layer will change this for you (don't try and snake case will cause errors later on)
	...
	public Donation(@Size(min = 3, max = 255) @NotNull(message = "donationName is required!") String donationName,
			@Size(min = 2, max = 50) @NotEmpty(message = "Description is required!") String donor,
